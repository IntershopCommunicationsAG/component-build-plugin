...
/**
 * CreateComponentDescriptor Gradle task 'createComponent'
 *
 ...
 */
open class CreateComponentDescriptor
    @Inject constructor(private val dependencyHandler: DependencyHandler) : DefaultTask() {
