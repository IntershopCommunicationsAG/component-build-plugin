...
|<<apreserve,preserve>>(Action<? super PatternFilterable> action) | Configures the patternset with an action. Files that matches to one of patterns will be preserved during the update installation.
|<<cpreserve,preserve>>(Closure closure) | Configures the patternset with a closure. Files that matches to one of patterns will be preserved during the update installation.
...
|<<mapreserve,preserve>>(Action<? super PatternFilterable> action) | Configures the patternset with an action. Files that matches to one of patterns will be preserved during the update installation.
|<<mcpreserve,preserve>>(Closure closure) | Configures the patternset with a closure. Files that matches to one of patterns will be preserved during the update installation.
...
|<<macontainerpreserve,preserve>>(Action<? super PatternFilterable> action) | Configures the patternset with an action. Files that matches to one of patterns will be preserved during the update installation.
|<<mccontainerpreserve,preserve>>(Closure closure) | Configures the patternset with a closure. Files that matches to one of patterns will be preserved during the update installation.
