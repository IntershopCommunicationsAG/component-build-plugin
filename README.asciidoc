...
| <<preserves,preserves>>                       | Files that matches to one of patterns will be preserved during the update installation.
...
[[preserves]]
[source,groovy]
Set<String> preserves

:::
Files that matches to one of the patterns will be preserved during the update installation. (*read only*)
Default:: `[]`
...
|<<scpreserve,preserve>>(pattern) | Adds a pattern to the set of preserve patterns. Files that matches to one of patterns will be preserved during the update installation.
|<<mapreserve,preserve>>(patterns) | Adds a set of patterns to the set of preserve patterns. Files that matches to one of patterns will be preserved during the update installation.
...
[[scpreserve]]
[source,groovy]
preserve(String pattern)

:::
Adds a pattern to the set of preserve patterns. Files that matches to one of the patterns will be preserved during the update installation.
...
|<<modulepreserves,preserves>>     | Files that matches to one of the patterns will be preserved during the update installation.
...
|<<containerpreserves,preserves>>     | Files that matches to one of the patterns will be preserved during the update installation.
|===
