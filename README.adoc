...
|<<modulesexcludedFromUpdate,excludedFromUpdate>> | If an item should not be part of an update installation, this property is set to true.
...
***
[[modulesexcludedFromUpdate]]
[source,groovy]
boolean excludedFromUpdate
...
|<<moduleexcludedFromUpdate,excludedFromUpdate>> | If this item should not be part of an update installation, this property is set to true.
...
|<<filesexcludedFromUpdate,excludedFromUpdate>> | If an item should not be part of an update installation, this property is set to true.
This property is used for all items and can be overridden by a configuration of the item.
|===
...
|<<fileexcludedFromUpdate,excludedFromUpdate>> | If this item should not be part of an update installation, this property is set to true.
|===
...
|<<containersexcludedFromUpdate,excludedFromUpdate>> | If an item should not be part of an update installation, this property is set to true.
This property is used for all items and can be overridden by a configuration of the item.
|===
...
|<<containerexcludedFromUpdate,excludedFromUpdate>> | If this item should not be part of an update installation, this property is set to true.
...
|<<propcludedFromUpdate,excludedFromUpdate>> | If this item should not be part of an update installation, this property is set to true.
|===
