...
For more information see <<LibraryItemContainer, `LibraryItemContainer`>>.
...
For more information see <<ModuleItemContainer, `ModuleItemContainer`>>.
...
For more information see <<DependencyMngtContainer, `DependencyMngtContainer`>>.
...
For more information see <<FileItemContainer, `FileItemContainer`>>.
...
For more information see <<FileContainerItemContainer, `FileContainerItemContainer`>>.
...
For more information see <<PropertyItemContainer, `PropertyItemContainer`>>.
