...
:::
Initialize container for library configuration. Instead of an action it is also possible to use a closure.
...
:::
Initialize container for modul configuration. Instead of an action it is also possible to use a closure.
...
:::
Initialize container for dependency management container. This includes also the configuration for the class collision verification. Instead of an action it is also possible to use a closure.
...
:::
Initialize container for single files. Instead of an action it is also possible to use a closure.
...
:::
Initialize container for additional file item containers. Instead of an action it is also possible to use a closure.
...
:::
Initialize container for properties. Instead of an action it is also possible to use a closure.
